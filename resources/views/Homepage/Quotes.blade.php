                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="flexCheckDefault">Landing Page</label>
                                                            </div>
                                                        </td>
                                                        <td>Simple, clean design with standard pages.</td>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="" id="flexCheckDefault">
                                                                <label class="form-check-label"
                                                                    for="flexCheckDefault">About Page</label>
                                                            </div>
                                                        </td>
                                                        <td>Simple, clean design with standard pages.</td>
                                                        <td class="text-center">20.00</td>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="" id="flexCheckDefault">
                                                                <label class="form-check-label"
                                                                    for="flexCheckDefault">Service Page</label>
                                                            </div>
                                                        </td>
                                                        <td>Simple, clean design with standard pages.</td>
                                                        <td class="text-center">20.00</td>
